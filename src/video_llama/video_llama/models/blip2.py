...
import src.video_llama.video_llama.common.dist_utils as dist_utils
from src.video_llama.video_llama.common.dist_utils import download_cached_file
from src.video_llama.video_llama.common.utils import is_url
from src.video_llama.video_llama.common.logger import MetricLogger
from src.video_llama.video_llama.models.base_model import BaseModel
from src.video_llama.video_llama.models.Qformer import BertConfig, BertLMHeadModel
from src.video_llama.video_llama.models.eva_vit import create_eva_vit_g
...
class Blip2Base(BaseModel):
    ...
    def init_tokenizer(cls, q_former_encoder_model="bert-base-uncased"):
        tokenizer = BertTokenizer.from_pretrained(q_former_encoder_model)
